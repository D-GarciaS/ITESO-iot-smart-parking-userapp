...
import mx.iteso.iot.androidappiot.retrofit.clients.IoTAPI.AuthenticationAPI
...
class ActivityLogin : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    private fun terminateIfLoggedIn() {
        val sp = getSharedPreferences("login",MODE_PRIVATE);
        val logged = sp.getBoolean("logged", false)
        if(logged){
    ...
    inner class UserLoginTask internal constructor(private val mEmail: String, private val mPassword: String) : AsyncTask<Void, Void, Boolean>() {
        ...
        lateinit var res : Response<AuthResponse>
        ...
        override fun doInBackground(vararg params: Void): Boolean? {
            ...
            try {
                ...
                //Thread.sleep(2000)
                val authAPI = BackEndService().client.create(AuthenticationAPI::class.java)
        ...
        override fun onPostExecute(success: Boolean?) {
            ...
            if (success!!) {
                val sp = getSharedPreferences("logged", Context.MODE_PRIVATE)
                sp.edit().putBoolean("logged",true).apply()

                val newIntent = Intent(baseContext, ActivityMain::class.java)
